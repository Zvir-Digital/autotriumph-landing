  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
        <div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#131022] dark:text-white mb-4 sm:mb-6 leading-tight">
            AutoTriumph
          </h1>
        ...
        <div className="hidden md:block">
          <div className="relative bg-gradient-to-br from-[#6366f1] to-[#7177f8] rounded-2xl p-8 shadow-xl overflow-hidden">
            <div className="relative w-full h-[400px] flex items-center justify-center">
              <DotLottieReact
                src="/animations/Robot Futuristic Ai animated.lottie"
                loop
                autoplay
